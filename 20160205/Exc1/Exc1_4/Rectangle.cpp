...
{
	if( xTopL < 0 || xTopL > 100 || xTopL >= xBottomRight_ )
	{
...
{
	if( yTopL < 0 || yTopL > 100 || yTopL >= yBottomRight_)
	{
...
{
	if( xBotR < 0 || xBotR > 100 || xBotR <= xTopLeft_)
	{
...
{
	if( yBotR < 0 || yBotR > 100 || yBotR <= yTopLeft_)
	{
